...
public class ProductoFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        producto.setCategoria(new Categoria()); //454 min 13
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(errores.isEmpty()) {
            ...
            //doGet(req,resp);           SE QUITO EN LA 455                                                 //CON EL ERROR, SE VUELVE A INVOCAR AL METODO DOGET() PARA VOLVER A MOSTRAR EL FORMULARIO.
            req.setAttribute("categorias", productoService.listarcategoria());
            req.setAttribute("producto", producto);
            getServletContext().getRequestDispatcher("/form.jsp").forward(req, resp);
        }
