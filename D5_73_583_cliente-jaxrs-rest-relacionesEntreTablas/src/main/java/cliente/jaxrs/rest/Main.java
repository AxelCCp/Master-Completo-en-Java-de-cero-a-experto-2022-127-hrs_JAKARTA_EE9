...
import cliente.jaxrs.rest.models.Instructor;
...
public class Main {
    public static void main(String[] args) {
        ...
        WebTarget rootUri = client.target("http://localhost:8080/webapp-jaxrs-rest-2/api").path("/cursos-json"); //1
        ...
        instructor.setId(2L);                             //ESTA LÍNEA ES LA NECESARIA
        instructor.setNombre("Pepe");                     //ESTA LÍNEA NO ES NECESARIA. SOLO PARA Q QUEDE MÁS COMPLETO.
        instructor.setApellido("Doe");                    //ESTA LÍNEA NO ES NECESARIA. SOLO PARA Q QUEDE MÁS COMPLETO.
