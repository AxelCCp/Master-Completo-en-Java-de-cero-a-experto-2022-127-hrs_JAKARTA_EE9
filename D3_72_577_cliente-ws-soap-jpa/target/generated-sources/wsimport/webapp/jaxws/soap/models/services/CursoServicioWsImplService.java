 ...
 * 
 */
@WebServiceClient(name = "CursoServicioWsImplService", targetNamespace = "http://services.models.soap.jaxws.webapp/", wsdlLocation = "http://localhost:8080/webapp-jaxws-soap-jpa/CursoServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CURSOSERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.models.soap.jaxws.webapp/", "CursoServicioWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webapp-jaxws-soap-jpa/CursoServicioWsImpl?wsdl");
    ...
    public CursoServicioWs getCursoServicioWsImplPort() {
        return super.getPort(new QName("http://services.models.soap.jaxws.webapp/", "CursoServicioWsImplPort"), CursoServicioWs.class);
    }
    ...
    public CursoServicioWs getCursoServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.models.soap.jaxws.webapp/", "CursoServicioWsImplPort"), CursoServicioWs.class, features);
    }
