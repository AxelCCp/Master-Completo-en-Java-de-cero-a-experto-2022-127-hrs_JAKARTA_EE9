...
public class ProducerResources {
    ...
    //532 - METODO PARA EL ENTITY MANAGER. ESTO FUNCIONA EN CONJUNTO CON EL ARCHIVO BEANS.XML (bean-discovery-mode="annotated">) ---> DEBE ESTAR EN "annotated", DE ESTA MANERA VA A REGISTRAR "UN SOLO ENTITY MANAGER" QUE SE CONFIGURA AQUÍ CON LAS ANOTACIONES.
    @Produces
    @RequestScoped
