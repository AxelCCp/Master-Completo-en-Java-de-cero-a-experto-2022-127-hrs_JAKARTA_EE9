 ...
 * 
 */
@WebServiceClient(name = "ServicioWsImplService", targetNamespace = "http://services.models.soap.jaxws.webapp/", wsdlLocation = "http://localhost:8080/webapp-jaxws-soap/ServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.models.soap.jaxws.webapp/", "ServicioWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webapp-jaxws-soap/ServicioWsImpl?wsdl");
    ...
    public ServicioWs getServicioWsImplPort() {
        return super.getPort(new QName("http://services.models.soap.jaxws.webapp/", "ServicioWsImplPort"), ServicioWs.class);
    }
    ...
    public ServicioWs getServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.models.soap.jaxws.webapp/", "ServicioWsImplPort"), ServicioWs.class, features);
    }
